...
const MegaMenuDropdown = () => {
  return <Dropdown as={'li'} className="nav-item dropdown dropdown-fullwidth">
      <DropdownToggle as={Link} href="" variant="link" className="nav-link mb-0 arrow-none d-flex w-100 justify-content-between align-items-center dropdown-toggle" id="megaMenu" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        Megamenu
        ...
        <Row className="p-2 p-sm-4 g-4">
          ...
          <Col md={6} xl={3}>
            <ul className="list-unstyled">
              ...
              <li>
                {MEGA_MENU_ITEMS.integration.map((item, idx) => <Link key={idx} className="dropdown-item d-flex bg-light-hover icon-link icon-link-hover py-2" href="">
