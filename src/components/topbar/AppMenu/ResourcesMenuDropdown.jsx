...
const ResourcesMenuDropdown = () => {
  ...
  return <Dropdown as={'li'} className="nav-item dropdown dropdown-fullwidth">
      <DropdownToggle as={Link} href="" variant="link" className="nav-link mb-0 arrow-none d-flex w-100 justify-content-between align-items-center dropdown-toggle" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        Resources
