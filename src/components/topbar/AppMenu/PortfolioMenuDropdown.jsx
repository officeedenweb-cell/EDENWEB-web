...
const PortfolioMenuDropdown = ({
  ...
  return <Dropdown className="nav-item dropdown">
      <DropdownToggle as={Link} href="" variant="link" className={`nav-link mb-0 arrow-none d-flex w-100 justify-content-between align-items-center dropdown-toggle${getActiveClass(activeMenuItems, 'portfolio')}`} data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        Portfolio
