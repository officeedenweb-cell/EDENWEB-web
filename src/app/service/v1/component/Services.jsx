...
export const ServiceCard = ({
  ...
  return <Card className="border bg-light p-5">
      ...
      <Container data-sticky-container>
        <Row>
          <Col lg={4} className="mb-5">
            <Sticky data-sticky topOffset={150} stickyStyle={{
            marginTop: 80
          }} boundaryElement="div.row" hideOnBoundaryHit={false} disabled={width <= 991}>
          ...
          <Col lg={8} className="ps-xl-7">
            <Row className="g-4 g-sm-5">
              {services.map((service, idx) => <Col md={6} key={idx}>
