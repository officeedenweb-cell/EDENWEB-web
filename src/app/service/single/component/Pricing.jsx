              ...
              <TabContainer defaultActiveKey={'0'}>
                ...
                <CardBody className="pt-0">
                  <TabContent id="pills-tabContent">
                    {pricingData.map((item, idx) => <TabPane key={idx} eventKey={`${idx}`} className="fade" tabIndex={0}>
                        <div className="bg-light border rounded p-3">
                          <h6 className="mb-3">Quick look at all the features</h6>
                          <ul className="list-group list-group-borderless">
                            {item.features.map((feature, idx) => <li className="list-group-item mb-0" key={idx}>
