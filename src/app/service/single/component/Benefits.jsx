...
const Benefits = () => {
  const benefits = ["Reach a global audience and expand your brand's presence", 'Real-time tracking and data-driven decision-making', 'Improved Customer Engagement', 'Drive conversions and boost revenue', 'Create a loyal customer community', 'Protect customer data and privacy'];
          ...
          <Col md={6}>
            <Card className="card-body bg-light border p-md-5">
              ...
              <ul className="list-group list-group-borderless border-0">
                {benefits.map((benefit, idx) => <li key={idx} className="list-group-item heading-color d-flex mb-0 icons-center">
