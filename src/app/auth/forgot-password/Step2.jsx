...
const Step2 = ({
  ...
  return <Form onSubmit={handleSubmit(goToNextStep)} id="step-2" role="tabpanel" className="content fade" aria-labelledby="steppertrigger2">
      <PageHeading heading="Password reset" subHeading={<>
      ...
      <div className="d-flex justify-content-between gap-1 gap-sm-3 mb-3 mt-4">
        ...
        field
      }) => <OTPInput maxLength={4} containerClassName="d-flex justify-content-between gap-1 gap-sm-3 mb-3 mt-4" autoFocus {...field} render={({
        slots
      }) => {
        return slots.map((slot, idx) => <div key={idx} className={styles.input_slot}>
