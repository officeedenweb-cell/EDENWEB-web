...
const PersonalInformationForm = () => {
  const personalInformationSchema = yup.object({
    ...
    mobile: yup.string().matches(/\d{10}/, {
          ...
          <Row className="g-4">
            ...
            <Col xs={12}>
              ...
              <div className="input-group">
                <TextFormInput type="text" className='form-control' placeholder="First name" name="firstName" control={control} />

                <TextFormInput type="text" className='form-control' placeholder="Last name" name="lastName" control={control} />
              </div>
            </Col>

            <TextFormInput name="email" containerClass="col-md-6" label="Email address" type="email" placeholder="Enter your email id" control={control} />

            <TextFormInput containerClass="col-md-6" placeholder="Enter your mobile number" name="mobile" label="Mobile number" control={control} />
