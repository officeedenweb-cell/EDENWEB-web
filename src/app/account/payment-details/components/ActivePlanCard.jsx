      ...
      <CardBody>
        ...
        <div className="mt-5">
          ...
          <div className="progress-stacked h-100 mb-2">
            <div className="progress progress-md" role="progressbar" aria-label="Segment one" aria-valuenow={45} aria-valuemin={0} aria-valuemax={100} style={{
            width: '45%'
          }}>
              <div className="progress-bar rounded-0" />
            </div>
            <div className="progress progress-md" role="progressbar" aria-label="Segment two" aria-valuenow={20} aria-valuemin={0} aria-valuemax={100} style={{
            width: '20%'
          }}>
