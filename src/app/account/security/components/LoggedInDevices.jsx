...
const LoggedInDevices = () => {
  return <Col md={6} lg={12} xl={6} as={'form'}>
      <Card className="bg-transparent rounded-3">
        ...
        <CardBody className="px-0">
          <LoggedInDeviceCard device={{
          name: 'Iphone 12pro',
          type: 'phone'
        }} location="London, UK" lastActiveAt="Oct 23 at 1:15PM" />

          <LoggedInDeviceCard device={{
          name: 'Iphone SE',
          type: 'phone'
        }} location="London, UK" lastActiveAt="Oct 13 at 4:15PM" />

          <LoggedInDeviceCard device={{
          name: 'Macbook pro',
          type: 'laptop'
        }} location="California, USA" lastActiveAt="Oct 20 at 5:15PM" />
