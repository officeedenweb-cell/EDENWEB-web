...
const CareerDetail = () => {
  const skills = ['Involving The Team In Decisions That Affect Them', 'Displays technical or professional expertise', 'Displays high integrity and honesty', 'Solves problems and analyzes issues', 'Communicates powerfully and prolifically'];
          ...
          <Col lg={10} className="col-xl-8 mx-auto">
            ...
            <Row>
              <Col md={6}>
                ...
                <ul className="list-group list-group-borderless mb-4">
                  {skills.map((skill, idx) => <li className="list-group-item d-flex mb-0 icons-center" key={idx}>
            ...
            <Card className="card-body bg-light border p-sm-5 mt-5" id="contact-form">
              <Row as={Form} className="g-4" onSubmit={handleSubmit(() => {})}>
                <TextFormInput name="name" type="text" label="Your name *" labelClass="heading-color" size="lg" control={control} placeholder="Full name" containerClass="col-md-6" />
                <TextFormInput name="email" type="email" label="Email address *" labelClass="heading-color" size="lg" control={control} placeholder="name@example.com" containerClass="col-md-6" />
                <TextFormInput name="phoneNo" type="text" label="Phone number *" labelClass="heading-color" size="lg" control={control} placeholder="(xxx) xx xxxx" containerClass="col-md-6" />
                <TextFormInput name="job" type="text" label="Applying for (Job position) *" labelClass="heading-color" size="lg" control={control} placeholder="Job title" containerClass="col-md-6" />
                <TextAreaFormInput name="message" label="Message *" labelClass="heading-color" style={{
                height: 150
              }} control={control} placeholder="Write your message here...." containerClass="col-md-6 w-100" />
