        ...
        <Row className="mt-7">
          <Col md={5} className="mb-5 mb-md-0">
            <Swiper {...swiperOptions}>
              {products[0].images.map((image, idx) => <SwiperSlide key={idx}>
          ...
          <Col md={7} className="ps-md-6">
            ...
            <div className="d-flex align-items-center flex-wrap mb-4">
              <ul className="list-inline mb-0">
                {Array(4).fill(0).map((_star, idx) => <li className="list-inline-item me-1" key={idx}>
            ...
            <div className="color-check-radio d-flex align-items-center gap-3 mt-2 mb-4">
              ...
              <div className="icons-center gap-1">
                <input className="form-check-input" type="radio" name="flexRadioDefault" id="flexRadioDefault1" style={{
                backgroundColor: '#9a0a0a'
              }} />
                <label className="form-check-label" htmlFor="flexRadioDefault1" />
                <input className="form-check-input" type="radio" name="flexRadioDefault" id="flexRadioDefault2" style={{
                backgroundColor: '#32C7F5'
              }} />
                <label className="form-check-label" htmlFor="flexRadioDefault2" />
                <input className="form-check-input" type="radio" name="flexRadioDefault" id="flexRadioDefault3" style={{
                backgroundColor: '#F7C32E'
              }} />
                <label className="form-check-label" htmlFor="flexRadioDefault3" />
                <input className="form-check-input" type="radio" name="flexRadioDefault" id="flexRadioDefault4" defaultChecked style={{
