          ...
          <Col lg={5} className="pe-lg-5 mb-5 mb-lg-0">
            <div className="border rounded-2 p-4">
              <Row>
                ...
                <Col md={7}>
                  {[95, 75, 55, 35, 25].map((progress, idx) => <div className="d-flex align-items-center" key={idx}>
                      <ProgressBar now={progress} style={{
                    height: '5px',
                    width: '100%'
                  }} variant="warning" className="me-3" />
            ...
            <div className="mt-5">
              ...
              <Row className="g-4">
                {reviewImages.map((image, idx) => <Col xs={4} sm={2} lg={3} key={idx}>
                    ...
                    <div>
                      <div className="d-sm-flex justify-content-between mb-2">
                        ...
                        <ul className="list-inline mb-0">
                          {review && Array(Math.floor(review.rating)).fill(0).map((_star, idx) => <li key={idx} className="list-inline-item me-1 small">
                          ...
                          {review && review.rating < 5 && Array(5 - Math.ceil(review.rating)).fill(0).map((_star, idx) => <li key={idx} className="list-inline-item me-1 small">
