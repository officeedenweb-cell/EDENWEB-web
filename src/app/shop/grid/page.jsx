  ...
  return <>
      ...
      <section className="pt-0">
        <Container>
          <Row>
            <Col xl={3} as={'aside'}> 
              {width < 1200 ? <Offcanvas show={showFilter} onHide={toggleFilter} placement="end" className="offcanvas-xl" tabIndex={-1} id="offcanvasSidebar" aria-labelledby="offcanvasSidebarLabel">
                ...
                </Offcanvas> : <VerticalProductFilter />}
            </Col>
              ...
              <Row className="g-4 g-lg-5">
                {productGrid.map((product, idx) => {
                  return <Fragment key={idx}>
                      ...
                      {idx == 2 && <Col sm={6} lg={12}>
                          <Card className="card-body h-100 p-md-6" style={{
                        backgroundImage: `url(${backgroundImg5.src})`,
