  ...
  return <>
      <Accordion defaultActiveKey={'1'} className="accordion-alt" id="accordionExample">
        ...
        <AccordionItem eventKey="1">
          ...
          <AccordionBody as={'form'}>
            {categories.map((category, idx) => <div className={`form-check ${idx === 0 ? '' : 'mt-2'}`} key={idx}>
        ...
        <AccordionItem eventKey="3">
          ...
          <AccordionBody as={'form'}>
            <div className="color-check-radio">
              <input className="form-check-input" type="radio" name="flexRadiocolor" id="flexRadiocolor1" style={{
              backgroundColor: '#9a0a0a'
            }} />
              <label className="form-check-label" htmlFor="flexRadiocolor1" />
              <input className="form-check-input" type="radio" name="flexRadiocolor" id="flexRadiocolor2" style={{
              backgroundColor: '#32C7F5'
            }} />
              <label className="form-check-label" htmlFor="flexRadiocolor2" />
              <input className="form-check-input" type="radio" name="flexRadiocolor" id="flexRadiocolor3" style={{
              backgroundColor: '#F7C32E'
            }} />
              <label className="form-check-label" htmlFor="flexRadiocolor3" />
              <input className="form-check-input" type="radio" name="flexRadiocolor" id="flexRadiocolor4" style={{
        ...
        <AccordionItem eventKey="4">
          ...
          <AccordionBody as={'form'}>
            <ul className="list-inline mb-0 g-3">
              {Array(5).fill(0).map((_star, idx) => <li className="list-inline-item mb-0" key={idx}>
