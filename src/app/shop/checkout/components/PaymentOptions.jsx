      ...
      <Card className="bg-transparent">
        ...
        <CardBody className="px-0">
          <Row className="g-4">
            ...
            return <Col md={6} lg={12} xl={6} key={idx}>
                  <div className="form-check border rounded p-3">
                    ...
                    <div className="d-flex justify-content-end gap-3 mt-3">
                      ...
                      {item.image && <Link href="" onClick={toggle} className="heading-color text-primary-hover fw-semibold small" data-bs-toggle="modal" data-bs-target="#editcard">
