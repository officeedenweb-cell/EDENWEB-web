...
const Hero = () => {
  ...
  return <section className="vh-xl-auto vh-100 bg-dark py-0 overflow-hidden" data-bs-theme="dark">
        ...
        <Row className="h-100 g-0">
          ...
          <Col lg={6} className="order-1 order-lg-2">
            <Swiper className="swiper-img-scale h-100" {...swiperOptions}>
              {swiperImages.map((image, idx) => <SwiperSlide key={idx}>
                  <div className="h-100 scale-img py-9" style={{
