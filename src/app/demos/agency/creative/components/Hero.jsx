...
const Hero = () => {
  ...
  return <section className="pt-xl-8 pb-0">
        ...
        <Row>
          <Col md={6} xl={7} className="mb-5 mb-md-0">
            ...
            <Swiper className="mt-2 mt-md-4" {...swiperOptions}>
              {clientsData.map((client, idx) => <SwiperSlide key={idx}>{client.image && <Image src={client.image} className="px-3 ps-0" alt="client-img" />}</SwiperSlide>)}
            </Swiper>
          </Col>
