...
const Pricing = () => {
  ...
  return <section className="pb-0 price-wrap">
      <Container>
        <Row className="g-4 g-lg-5">
          ...
          {
            if (item.duration === planDuration) return <Col sm={6} lg={4} key={idx}>
                      ...
                      return <li className="list-group-item heading-color mb-0" key={idx}>
