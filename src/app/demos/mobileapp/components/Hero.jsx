            ...
            <Col lg={6} className=" position-relative">
              ...
              <Row>
                ...
                <div className="col-6 d-none d-sm-block">
                  <div className="iphone-x iphone-x-small rotate-13 m-0 ms-3 mt-xl-n7" style={{
