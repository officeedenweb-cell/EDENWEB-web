        ...
        <div className="container">
          <Row className=" g-4 align-items-center">
            <div className="col-lg-6 position-relative order-2">
              <div className="bg-dark rounded d-none d-sm-flex align-items-center z-index-2 position-absolute top-0 end-0 me-8 px-3 py-2" style={{
              maxWidth: 330
            }}>
