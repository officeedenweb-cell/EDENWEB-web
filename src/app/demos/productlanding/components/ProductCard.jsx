...
const ProductCard = ({
  ...
  return <Card className="bg-transparent text-center p-0">
      ...
      <CardBody className="p-0 mt-3">
        ...
        {product.sale ? <div className="d-flex align-items-center justify-content-center mb-3">
          ...
          </div> : <h6 className="fw-normal mb-3 me-1">
            {currency}
            {product.price}
          </h6>}
