  ...
  return <section className="pb-0">
      <Container>
        <Row className="g-0 bg-light rounded overflow-hidden">
          <Col md={6}>
            <Card className="card-body bg-transparent d-block p-4 p-md-5 p-lg-7 h-100">
              ...
              <ul className="list-group list-group-borderless mb-4">
                ...
                return <li className="list-group-item d-flex heading-color pb-0 icons-center" key={idx}>
          ...
          <Col md={6}>
            <div className="h-100 py-8 py-md-0" style={{
            background: `url(${about8.src}) no-repeat`,
