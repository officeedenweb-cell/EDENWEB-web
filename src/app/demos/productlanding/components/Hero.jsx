          ...
          <Col sm={10} lg={5} className="position-relative px-5 mx-auto">
            ...
            <div className="position-absolute top-0 start-0">
              <div className="position-relative">
                <OverlayTrigger placement="right" trigger="focus" overlay={<Popover className="p-2">And here&apos;s some amazing content. It&apos;s very engaging. Right?</Popover>}>
