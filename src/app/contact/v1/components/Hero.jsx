...
const Hero = () => {
  ...
  return <section className="pt-xl-8">
      <Container>
              ...
              <Col xs={11} lg={9} className="mx-auto">
                <Card className="shadow p-4 p-sm-5 p-md-6">
                  ...
                  <Form onSubmit={handleSubmit(() => {})} className="card-body px-0 pb-0 pt-5">
                    ...
                    <TextFormInput name="email" label="Email address" containerClass="mb-4" control={control} placeholder="name@example.com" floating />
                    <TextFormInput name="phoneNo" label="Phone number" containerClass="mb-4" control={control} placeholder="phone number" floating />

                    <TextAreaFormInput name="message" label="Message" containerClass="mb-4" control={control} placeholder="Leave a comment here" style={{
                    height: 100
                  }} floating />
