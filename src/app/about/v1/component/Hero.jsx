...
const Hero = () => {
  ...
  return <section className="bg-dark pt-sm-8 pb-9" data-bs-theme="dark">
        ...
        <Row className="g-4 g-xxl-5">
          ...
          <Col lg={4} xl={3} className="ms-auto position-relative">
            <ul className="list-group list-group-borderless mb-4">
              {list.map((item, idx) => <li key={idx} className="list-group-item d-flex heading-color pb-0 icons-center">
