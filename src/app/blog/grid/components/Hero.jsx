      ...
      <Container className="pt-3 pt-xl-5">
        <Swiper className="rounded" {...swiperOptions}>
          ...
          <div className="d-flex justify-content-between position-absolute top-50 start-0 w-100 px-1 px-sm-3">
            <Link href="" className="btn btn-dark btn-icon rounded-circle mb-0 swiper-button-prev" style={{
            height: "40px",
            width: "40px"
          }}>
              <BsArrowLeft className='bi' />
            </Link>
            <Link href="" className="btn btn-dark btn-icon rounded-circle mb-0 swiper-button-next" style={{
            height: "40px",
            width: "40px"
          }}>
