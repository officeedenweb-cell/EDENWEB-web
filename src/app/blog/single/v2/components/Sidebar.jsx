...
const Sidebar = () => {
  ...
  return <Col lg={4} className="ps-xl-6">
      ...
      <div className="align-items-center mt-5">
        ...
        <ul className="list-group list-group-flush">
          {relatedPost.map((post, idx) => <li className="list-group-item ps-0" key={idx}>
      ...
      <div className="align-items-center mt-5">
        ...
        <ul className="list-inline mb-0">
          {popularTags.map((tag, idx) => <li className="list-inline-item" key={idx}>
