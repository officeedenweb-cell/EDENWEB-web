...
const PricingCard = ({
  ...
  return <Card className="card-body border rounded p-md-4" data-bs-theme={plan.isPopular && 'dark'}>
      ...
      <ul className="list-group list-group-borderless border-0 mb-0 mt-2">
        ...
        return <li className="list-group-item d-flex mb-0 icons-center" key={idx}>
