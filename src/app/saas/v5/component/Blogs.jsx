                ...
                <Card as={'article'} className="bg-primary p-4 overflow-hidden h-100">
                  ...
                  <CardBody className="z-index-1 p-0">
                    <div className="d-flex justify-content-between mb-5">
                      ...
                      <OverlayTrigger placement="top" trigger="focus" overlay={<Popover className="p-2">You&apos;re seeing this ad because your activity meets the intended audience of our site.</Popover>}>
