...
import { BsArrowRight, BsBasket, BsBoxes, BsCheck, BsDiagram3, BsFunnel, BsGear, BsPatchCheckFill, BsPeople, BsPieChart, BsShieldCheck } from 'react-icons/bs';
const Features = () => {
  return <section className="bg-dark position-relative overflow-hidden" data-bs-theme="dark">
      ...
      <figure className="position-absolute top-0 end-0 me-n9 mt-n7 d-none d-md-block">
        <svg className="fill-white" width="768.8px" height="1386px" viewBox="0 0 768.8 1386" style={{
        opacity: 0.07
      }}>
                    ...
                    <Col lg={4} className="position-relative ms-auto">
                      ...
                      <Card className="card-body position-absolute bottom-0 start-0 ms-lg-n8 mb-n5">
                        ...
                        <div className="overflow-hidden">
                          ...
                          <ProgressBar now={80} variant="primary" style={{
                          width: '100%',
                          height: '5px'
                        }} />
                        </div>
