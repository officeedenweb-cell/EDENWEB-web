...
const Hero = () => {
  return <section className="overflow-hidden pt-xl-8 mb-n6 parallax-wrap">
      <Container className="position-relative zindex-5 pt-5">
        <Row className="justify-content-xl-start justify-content-center flex-xl-nowrap">
          ...
          <Col xl={10} className="d-flex rotate-343 position-relative aos z-index-2" data-aos="zoom-in-up" data-aos-delay="200" data-aos-duration="1000" data-aos-easing="ease-in-out">
            <Parallax>
              ...
              <Image src={decoration3} data-depth="0.8" className="rounded-3 layer shadow position-absolute bottom-0 start-0 ms-8 d-none d-lg-block" alt="" />

              <Image src={decoration4} data-depth="0.3" className="rounded-3 layer shadow position-absolute bottom-0 end-0 me-9 mb-4 d-none d-sm-block" alt="" />
            </Parallax>
          </Col>
        </Row>
      </Container>
