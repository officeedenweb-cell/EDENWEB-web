...
const CTA = () => {
  ...
  return <section className="position-relative z-index-2 pt-0">
      <Container className="position-relative">
        <div className="bg-dark rounded position-relative overflow-hidden p-4 p-sm-7">
          <figure className="position-absolute top-0 start-0 mt-n5">
            <svg className="fill-light" style={{
            opacity: 0.02
          }} width="662" height="614" viewBox="0 0 662 614" xmlns="http://www.w3.org/2000/svg">
