...
const PricingPlanCard = ({
  ...
  return <Card className={`p-0 border ${plan.isPopular ? 'border-primary' : 'shadow'}`}>
      {plan.isPopular && <div className="bg-primary text-white rounded position-absolute top-0 start-50 translate-middle px-2 py-1 ">Most popular</div>}
      ...
      <CardBody className={`p-4 ${plan.isPopular ? 'bg-primary bg-opacity-10' : ''}`}>
        <div className="text-center text-lg-start">
          ...
          <ul className="list-group list-group-borderless mb-2 mb-sm-4">
            ...
            return <li className="list-group-item d-flex heading-color mb-0 icons-center" key={idx}>
