...
const Hero = () => {
  return <section className="pt-7 pb-0">
      <Container fluid className="pt-3 pt-xl-5">
        <Row>
          <Col xxl={11} className="mx-auto">
            <Jarallax className="card bg-parallax h-300px h-md-400px h-xl-500px overflow-hidden" style={{
            background: `url(${backgroundImg4.src}) no-repeat`,
