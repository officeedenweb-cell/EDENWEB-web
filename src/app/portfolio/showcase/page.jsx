          ...
          <Container className="pt-4 pt-lg-0">
            ...
            <Row className="g-sm-6">
              <Col md={6} className="mb-5 mb-md-0">
                <ShowcaseCard brandImage={clientWhite3} image={showcase3} title="UI/UX Enhancement for SnapMedia" subTitle="UI/UX design" link="/portfolio/case-study/v2" />
              </Col>
              <Col md={6} className="mb-5 mb-md-0">
                <ShowcaseCard brandImage={clientWhite4} image={showcase2} title="Website Optimization for TechWave" subTitle="Web design" link="/portfolio/case-study/v1" />
              </Col>
              <Col xs={12} className="mb-5 mb-md-0">
                <ShowcaseCard brandImage={clientWhite2} image={showcase1} title="Chasing Dreams and Creating Art" subTitle="Branding" link="/portfolio/case-study/v2" />
              </Col>
              <Col md={6} className="mb-5 mb-md-0">
                <ShowcaseCard brandImage={clientWhite1} image={showcase5} title="The Art of Storytelling" subTitle="Graphics design" link="/portfolio/case-study/v1" />
              </Col>
              <Col md={6} className="mb-5 mb-md-0">
                <ShowcaseCard brandImage={clientWhite5} image={showcase4} title="Transforming Ideas into Reality" subTitle="Marketing" link="/portfolio/case-study/v2" />
              </Col>
            </Row>
